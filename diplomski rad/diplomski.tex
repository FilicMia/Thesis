...
Rješenja lineariziranog i nelineariziranog sustava nisu u potpunosti jednaka, ali su u ovom slučaju dovoljno bliska jer su jednadžbe sustava skoro pa linearne \cite{singer07}.%slide 16
...
Prijašnje metode ne određuju poziciju prijemnika u okvirima dopuštene točnosti.
Moguće je da su pojedine jednadžbe točnije, a druge manje točne. Neka to ima utjecaj na određivanje položaja.\\
Upravo uvođenjem težina modelira se točnost pojedine jednadžbe sustava.\\
...
Glavno sadrži najmanje onoliko nezavisnih jednadžbi koliko sustav ima nepoznanica.
